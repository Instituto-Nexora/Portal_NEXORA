    ...
    <section className={cn("py-20 px-6 bg-white")} id="projetos" aria-labelledby="projetos-title">
      <div className={cn("max-w-5xl mx-auto")}>
        <div className={cn("text-center mb-12")}>
          <h2 id="projetos-title" className={cn("text-3xl font-bold text-slate-900 mb-3")}>
            Nossos Projetos
          </h2>
                ...
                >
                  <CardHeader>
                    <div className={cn("flex items-center gap-3 mb-2")}>
                      <div className={cn("size-9 rounded-lg bg-teal-100 flex items-center justify-center shrink-0")}>
                        <Icon className={cn("size-5 text-teal-600")} aria-hidden="true" />
                      </div>
                      <CardTitle className={cn("text-slate-900")}>{projeto.title}</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
